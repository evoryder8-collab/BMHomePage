    ...
    <div className="bg-obsidian-soft">
      <div className="container-page grid gap-14 py-16 md:grid-cols-2 md:py-20">
        <div>
          ...
          <Reveal delay={0.1}>
            <p className="mt-5 max-w-md text-base leading-relaxed text-pearl/65">
        ...
        <Reveal delay={0.12}>
          <form
            onSubmit={onSubmit}
            className="space-y-4 rounded-2xl border border-pearl/10 bg-obsidian-soft p-7 shadow-sm"
          >
            <label className="block">
              ...
              <input
                ...
                required
                className="w-full rounded-xl border border-pearl/15 px-4 py-3 text-sm outline-none focus:border-pearl/40"
            ...
            <label className="block">
              ...
              <textarea
                ...
                required
                rows={6}
                className="w-full resize-y rounded-xl border border-pearl/15 px-4 py-3 text-sm outline-none focus:border-pearl/40"
            ...
            <p className="text-center text-xs text-pearl/45">
