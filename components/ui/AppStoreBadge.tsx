...
export default function AppStoreBadge({ href = "#" }: { href?: string }) {
  return (
    <a
      href={href}
      className="inline-flex items-center gap-2.5 rounded-xl border border-ink/15 bg-linen px-4 py-2.5 text-ink shadow-sm transition-transform hover:scale-[1.03]"
