...
export default function AppStoreBadge({ href = "#" }: { href?: string }) {
  return (
    <a
      href={href}
      className="inline-flex items-center gap-2.5 rounded-xl border border-ink/15 bg-ink px-4 py-2.5 text-ivory shadow-sm transition-transform hover:scale-[1.03]"
    ...
    >
      ...
      <span className="text-left leading-tight">
        <span className="block text-[10px] uppercase tracking-wide text-ivory/70">
          Download on the
        </span>
